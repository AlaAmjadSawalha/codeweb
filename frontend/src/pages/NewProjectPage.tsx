...
export default function CreateProjectPage({ setPage }: CreateProjectPageProps) {
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <h3 className="text-xl font-bold text-gray-900">Blueprint Mode</h3>
                    <p className="text-sm text-gray-500 px-2">Upload an architectural blueprint or floor plan in PDF or image format. AI will analyze dimensions.</p>
                </div>
                ...
                >
                    ...
                    <h3 className="text-xl font-bold text-gray-900">Real Space Mode</h3>
                    <p className="text-sm text-gray-500 px-2">Upload photos of an existing room or space. AI will estimate dimensions based on images.</p>
                </div>
                ...
                >
                    ...
                    <h3 className="text-xl font-bold text-gray-900">Inspiration Mode</h3>
                    <p className="text-sm text-gray-500 px-2">Start without images. Enter space details and preferences, and AI will generate conceptual ideas.</p>
                </div>
            </div>
        </div>
    );
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm space-y-6">
                        <div className="text-center mb-6">
                            <h2 className="text-2xl font-bold text-gray-900">Space Details</h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium text-gray-700">Total Area (m² or sqft)</label>
                                <input
                                    type="text"
                    ...
                    {formData.uploadedFiles.length > 0 && (
                        <div className="space-y-4">
                            <h4 className="text-lg font-bold text-gray-900 flex items-center justify-between">
                                <span>Uploaded Files <span className="text-gray-500 text-sm font-normal ml-2">({formData.uploadedFiles.length})</span></span>
                            </h4>
                    ...
                    {!isBlueprint && (
                        <div className="bg-purple-50 p-6 rounded-2xl border border-purple-100 space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-gray-900">Reference Measurement</h4>
                                    <p className="text-sm text-purple-700">Provide one known dimension to help the AI scale accurately.</p>
                                </div>
                            </div>

                            <div className="flex gap-4">
                                <div className="flex-1 space-y-2">
                                    <label className="text-xs font-bold text-purple-900 uppercase">Known Length</label>
                                    <input
                                        type="number"
                                        step="0.1"
                                        placeholder="e.g. 4.5"
                                ...
                                <div className="w-1/3 space-y-2">
                                    <label className="text-xs font-bold text-purple-900 uppercase">Unit</label>
                                    <select
                                        className="w-full px-4 py-3 rounded-xl border border-purple-200 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all outline-none bg-white"
    ...
    const renderStep3 = () => {
        ...
        return (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="text-center space-y-2 mb-8">
                    <h2 className="text-3xl font-bold text-gray-900">Design Preferences</h2>
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-4 mt-4 p-3 rounded-xl border border-gray-200">
                                ...
                                <span className="font-medium text-gray-700">Custom selection</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-y-8 gap-x-12">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="bg-gray-50 rounded-xl p-4 space-y-3 border border-gray-100">
                                    <div className="flex justify-between items-center"><span className="text-gray-500">Entry Mode</span> <span className="font-semibold text-gray-900 capitalize px-2 py-1 bg-blue-100 text-blue-700 rounded-md text-sm">{formData.entryMode.replace('_', ' ')}</span></div>
                                </div>
                            </div>
                            ...
                            {formData.uploadedFiles.length > 0 && (
                                <div>
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-4 space-y-3 border border-gray-100">
                                        <div className="flex justify-between"><span className="text-gray-500">Uploaded Files</span> <span className="font-medium text-gray-900">{formData.uploadedFiles.length} file(s)</span></div>
                                        {formData.referenceMeasurement && (
                                            <div className="flex justify-between"><span className="text-gray-500">Known Ref</span> <span className="font-medium text-purple-700 bg-purple-100 px-2 rounded">{formData.referenceMeasurement} {formData.measurementUnit}</span></div>
                                        )}
                                    </div>
                                </div>
                            )}
                            ...
                            {formData.entryMode === 'inspiration' && (
                                <div>
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-4 space-y-3 border border-gray-100">
                                        <div className="flex justify-between"><span className="text-gray-500">Project Name</span> <span className="font-medium text-gray-900">{formData.projectName || "Untitled"}</span></div>
                                        <div className="flex justify-between"><span className="text-gray-500">Type</span> <span className="font-medium text-gray-900 capitalize">{formData.roomType || "-"}</span></div>
                                        <div className="flex justify-between"><span className="text-gray-500">Area</span> <span className="font-medium text-gray-900">{formData.totalArea || "-"}</span></div>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="bg-gray-50 rounded-xl p-4 space-y-3 border border-gray-100">
                                    <div className="flex justify-between"><span className="text-gray-500">Style</span> <span className="font-medium text-gray-900">{formData.designStyle || "-"}</span></div>
                                    <div className="flex justify-between"><span className="text-gray-500">Layout</span> <span className="font-medium text-gray-900">{formData.layoutStyle || "-"}</span></div>
                                    <div className="flex justify-between"><span className="text-gray-500">Usage</span> <span className="font-medium text-gray-900">{formData.roomUsage || "-"}</span></div>
                                    ...
                                    <div className="flex justify-between"><span className="text-gray-500">Furniture</span> <span className="font-medium text-gray-900">{formData.furniturePreference || "-"}</span></div>
                                    <div className="flex justify-between"><span className="text-gray-500">Budget</span> <span className="font-semibold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded">{formData.budget === 'Custom' ? formData.customBudget : formData.budget || "-"}</span></div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                {step === 1 && (
                    <div className="mb-10 text-center space-y-4 animate-in slide-in-from-top-4 duration-500">
                        <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">Create New Project</h1>
