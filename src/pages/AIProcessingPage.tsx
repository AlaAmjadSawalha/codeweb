        ...
        <div className="min-vh-100 bg-gray-50 d-flex flex-column align-items-center justify-content-center p-4 font-sans relative overflow-hidden">
            ...
            <div className="max-w-2xl w-100 text-center space-y-12 z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <div className="space-y-4">
                    <h1 className="fs-1 font-extrabold text-gray-900 tracking-tight">Generating Your Design</h1>
                    <p className="fs-5 text-gray-500 max-w-xl mx-auto">
                ...
                <div className="space-y-3 max-w-md mx-auto">
                    <div className="d-flex justify-content-between align-items-end mb-1">
                        <span className="fs-6 text-muted fw-bold text-gray-700">Overall Progress</span>
                        <span className="fs-4 font-extrabold text-blue-600">{Math.floor(progress)}% Complete</span>
                    </div>
                ...
                <div className="pt-8">
                    <button
                        ...
                        className="fs-6 text-muted fw-medium text-gray-400 hover:text-red-500 transition-colors"
                    >
                        Cancel Generation
                    </button>
                </div>
