                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
                        <div className="flex-1 text-center lg:text-left space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
                            <button
                                ...
                                className="inline-flex items-center rounded-full border border-indigo-200 bg-indigo-50/50 dark:border-indigo-800 dark:bg-indigo-900/30 px-3 py-1 text-sm font-medium text-indigo-800 dark:text-indigo-300 backdrop-blur-sm mx-auto lg:mx-0 hover:opacity-90 transition-opacity"
                            >
