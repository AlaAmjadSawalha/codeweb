        ...
        <div className="p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b pb-6">
                <div>
                    ...
                    <div className="flex items-center gap-3">
                        <h1 className="text-3xl font-bold tracking-tight">Open Concept Minimalist</h1>
                        <div className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-green-100 text-green-700 font-bold text-sm">
                            94
                        </div>
                    </div>
                    <p className="text-muted-foreground mt-1">Version 1.0 &bull; Generated today</p>
                </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    {/* Detailed Scores */}
                    <div className="rounded-xl border bg-card text-card-foreground p-6 shadow-sm">
                        <h3 className="font-semibold text-lg mb-6">Design Scores</h3>
                        <div className="space-y-5">

                            <div className="space-y-2">
                                <div className="flex justify-between items-center text-sm">
                                    <span className="font-medium flex items-center gap-2"><Icons.layoutTemplate className="h-4 w-4 text-blue-500" /> Space Efficiency</span>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center text-sm">
                                    <span className="font-medium flex items-center gap-2"><Icons.lightbulb className="h-4 w-4 text-amber-500" /> Lighting Integration</span>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center text-sm">
                                    <span className="font-medium flex items-center gap-2"><Icons.settings className="h-4 w-4 text-pink-500" /> Comfort & Flow</span>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center text-sm">
                                    <span className="font-medium flex items-center gap-2"><Icons.folder className="h-4 w-4 text-emerald-500" /> Functionality</span>
                    ...
                    <div className="rounded-xl border bg-card text-card-foreground p-6 shadow-sm bg-muted/20">
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex justify-between items-center border-b pb-2">
                                <span className="text-muted-foreground">Demolition & Structural</span>
                                <span className="font-medium">$1,500</span>
                            </div>
                            <div className="flex justify-between items-center border-b pb-2">
                                <span className="text-muted-foreground">Materials (Paint, Trim)</span>
                                <span className="font-medium">$1,250</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-muted-foreground">Labor & Contingency</span>
                                <span className="font-medium">$1,500</span>
                            </div>
                        </div>
